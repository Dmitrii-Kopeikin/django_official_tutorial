...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a publication_date in the future aren't displayed on the index page.
        """
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for question whose publication_date is in the future.
        """
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently returns False for question whose publication_date is older than 1 day.
        """
